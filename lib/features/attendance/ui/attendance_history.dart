...
class _AttendanceHistoryPageState extends ConsumerState<AttendanceHistoryPage> {
  ...
  Future<void> _onRefresh() async {
    ...
    ref.invalidate(studentByClass(widget.classId));
                          ...
                          return Align(
                            ...
                            child: Padding(
                              ...
                              child: Button(
                                ...
                                // },
                                onPressed: () async {
                                  final newRecap = await ref.refresh(
                                    attendanceMonthlyRecapProvider((
                                      widget.classId,
                                      selectedDate,
                                    )).future,
                                  );
                                  ...
                                  final student = await ref.read(
                                    studentByClass(widget.classId).future,
                                  );
                ...
                data: (attendanceList) {
                  ...
                  return SliverList(
                    delegate: SliverChildBuilderDelegate((context, index) {
                      ...
                      final attendanceId = sortedAttendanceList[index].id;
